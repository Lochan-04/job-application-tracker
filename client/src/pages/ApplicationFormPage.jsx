...
export default function ApplicationFormPage() {
  ...
  const pageTitle = id ? "Edit application" : "Add application";
    ...
    <section className="grid gap-6 xl:grid-cols-[0.72fr_1.28fr]">
      <aside className="space-y-6">
        <div className="rounded-[2rem] border border-ink/10 bg-[linear-gradient(135deg,_rgba(11,23,42,0.98),_rgba(19,34,56,0.92))] p-8 text-white shadow-card">
          <p className="text-sm font-medium uppercase tracking-[0.25em] text-white/50">Application form</p>
          <h1 className="mt-2 font-display text-4xl font-bold">{pageTitle}</h1>
          <p className="mt-4 text-white/70">Save the basics, keep your notes together, and update the record whenever something changes.</p>
        </div>
      </aside>
